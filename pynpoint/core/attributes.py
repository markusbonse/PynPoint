...
def get_attributes() -> Dict[str, Dict[str, Union[str, float, int, None]]]:
    ...
    attr = {'PIXSCALE': {'attribute': 'static',
            ...
            'DITHER_Y': {'attribute': 'non-static',
                         ...
                         'type': 'float'},
            'WIN_START_X': {'attribute': 'static',
                            'config': 'header',
                            'value': 'ESO DET WIN STARTX',
                            'type': 'int'},
            'WIN_START_Y': {'attribute': 'static',
                            'config': 'header',
                            'value': 'ESO DET WIN STARTY',
                            'type': 'int'},
            'WIN_SIZE_X': {'attribute': 'static',
                           'config': 'header',
                           'value': 'ESO DET WIN NX',
                           'type': 'int'},
            'WIN_SIZE_Y': {'attribute': 'static',
                           'config': 'header',
                           'value': 'ESO DET WIN NY',
                           'type': 'int'},
